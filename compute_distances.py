...
def hausdorff_same_target_edges(base_mesh_name, criterion_name, target_mesh_path, dir_path_micro, dir_path_aniso):
...
parser.add_argument("--criterion", default="same-target-edges", help="Parameter 7 (criterion)")
...
if args.criterion == "same-microfaces":
  hausdorff_same_microfaces(args.base_mesh[:-4], target_mesh_faces,
                            target_mesh_path, dir_path_micro, dir_path_aniso)
elif args.criterion == "same-target-edges":
  hausdorff_same_target_edges(args.base_mesh[:-4], criterion_name,
                              target_mesh_path, dir_path_micro, dir_path_aniso)
